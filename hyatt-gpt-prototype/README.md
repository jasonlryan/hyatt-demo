...
ENABLE_REAL_DATA_SOURCES=false  # Real data sources are disabled by default
...
```bash
# Set in .env
ENABLE_REAL_DATA_SOURCES=false  # Use mock data
ENABLE_DYNAMIC_FLOW=true
ENABLE_QUALITY_CONTROL=true
```
...
```bash
# Set in .env
ENABLE_REAL_DATA_SOURCES=true  # Requires valid API keys
