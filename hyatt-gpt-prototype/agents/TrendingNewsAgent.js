...
class TrendingNewsAgent {
  ...
  loadSystemPrompt() {
    try {
      ...
      const possiblePaths = [
        path.join(__dirname, "../GPTs/trending_news_gpt.md"), // Local GPTs in app folder (Vercel)
        path.join(process.cwd(), "GPTs/trending_news_gpt.md"), // Vercel deployment alternative
        path.join(__dirname, "../../GPTs/trending_news_gpt.md"), // Local development (parent dir)
