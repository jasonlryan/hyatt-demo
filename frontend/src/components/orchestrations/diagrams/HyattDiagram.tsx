  ...
  nodes: [
    {
      ...
      connectors: [{ id: "brief-R", position: "R" }],
      style: outlinedStyle,
    },
    {
      id: "pr",
    ...
    },
    {
      ...
      position: { x: centerX + 2 * offsetX, y: centerY },
      connectors: [{ id: "final-L", position: "L" }],
      style: outlinedStyle,
    },
  ],
  edges: [
